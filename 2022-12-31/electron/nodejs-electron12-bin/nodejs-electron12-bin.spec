...
Provides:       nodejs-electron12 electron12
...
%install
cd "$RPM_SOURCE_DIR"
install -dm755 "${RPM_BUILD_ROOT}/usr/lib/electron12"
bsdtar -xf %{SOURCE0} -C "${RPM_BUILD_ROOT}/usr/lib/electron12"

chmod u+s "${RPM_BUILD_ROOT}/usr/lib/electron12/chrome-sandbox"

install -Dm755 %{SOURCE1} "${RPM_BUILD_ROOT}/usr/bin/electron12"
%post
%postun
